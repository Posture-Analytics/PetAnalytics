...
void setup() {
    ...
    timer = timerBegin(0, 80, true); // Configura o timer (0 é o número do timer, 80 é o divisor para 1 microsegundo)

    // Conecta o timer à função de interrupção
    timerAttachInterrupt(timer, &onTimer, true); // 'true' indica borda positiva para o disparo

    // Configura o alarme do timer
    timerAlarmWrite(timer, 1000000, true); // 1.000.000 ticks = 1 segundo; 'true' para reiniciar automaticamente

    // Ativa o alarme do timer
